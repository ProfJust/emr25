...
"""# neue DH-Parameter für Webots UR3e vgl. Proto Datei
# DH-Parameter für UR3e (a, d, alpha, theta)
dh_params = [
    [ 0.0000, 0.152,   np.pi/2, 0],    # Gelenk 1 Base
    [ 0.2440, 0.0000,  0.00000, -np.pi/2],    # Gelenk 2 Shoulder
    [ 0.2130, 0.0000,  0.00000, 0],    # Gelenk 3 Elbow
    [ 0.0000, 0.104,   np.pi/2, 0],    # Gelenk 4 Wrist1 
    [ 0.0000, 0.085,  -np.pi/2, 0],    # Gelenk 5 Wrist 2
    [ 0.0000, 0.09,          0, 0]     # Gelenk 6 Wrist 3    d= 0.0819 mit Gripper + 0.174 => 0.2559
]
"""
